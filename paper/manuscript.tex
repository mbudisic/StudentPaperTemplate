...
To include a citation, enter |\cite{Hill1894}| where Hill1894 is the paper label designated in the bib file.


 \subsection{Some \textbf{important formatting tips}:}
 \begin{compactitem}
 \item \textbf{Each sentence on its own line.} This helps with version control.
